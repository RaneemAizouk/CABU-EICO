...
# Simulated data:
#  Acquisition rate (1→2) includes seasonal effect: sine + cosine wave.
...
#writeLines(stan_model_full, "./Scripts/Models_and_code_raneem/Latest/Simulations/stan_models/two_step_model_spline.stan")
...
saveRDS(file = "./Output/Validation_with_simulated_data/two_step_spline_season_simulated.rds")
