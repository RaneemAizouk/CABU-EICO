---
title: "Gillespie Direct Algorithm"
output: html_document
date: "2023-11-25"
---
# Introduction
 This R code performs a stochastic simulation of the spread of infection within a household using the Gillespie Direct Algorithm. 
```{r}
