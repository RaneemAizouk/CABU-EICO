...
# Authors: Raneem Aizouk; Esther van Kleef
...
scenario    <- Sys.getenv("scenario", "One_step_spline_seasonality")
...
generated quantities {
 ...
 if (n == 1 || menage_id_member[n] != menage_id_member[n-1]) {
      ...
      log_lik[n] = 0;  // no preceding interval => no likelihood contribution
      continue;
    }
