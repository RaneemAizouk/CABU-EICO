...
model {
  ...
  a_raw_1_2     ~ normal(0, 0.5);
  a_raw_2_1     ~ normal(0, 0.5);
      ...
      if (first_subinterval[n] > 0) {
        ...
        if (t0 < t_star1 && t_star1 < t1) {
          ...
          P_total *= transition_matrix(
            ...
            exp(lambda21 + 0*beta_int1 + 0*beta_int2 + s21)
          );
          ...
          P_total *= transition_matrix(
            ...
            exp(lambda21 + flag1_post1*beta_int1 + flag2_post1*beta_int2 + s21)
          );
          ...
          P_total *= transition_matrix(
            ...
            exp(lambda21 + flag1_1*beta_int1 + flag2_1*beta_int2 + s21)
          );
        }
      }
      ...
      for (m in 1:num_middle_subintervals[n]) {
        ...
        if (t0m < t_star1 && t_star1 < t1m) {
          ...
          P_total *= transition_matrix(
            ...
            exp(lambda21 + 0*beta_int1 + 0*beta_int2 + s21_m)
          );
          ...
          P_total *= transition_matrix(
            ...
            exp(lambda21 + flag1_post1m*beta_int1 + flag2_post1m*beta_int2 + s21_m)
          );
          ...
          P_total *= transition_matrix(
            ...
            exp(lambda21 + flag1_2m*beta_int1 + flag2_2m*beta_int2 + s21_m)
          );
        }
      }
      ...
      if (last_subinterval[n] > 0) {
        ...
        if (t0l < t_star2 && t_star2 < t1l) {
          ...
          P_total *= transition_matrix(
            ...
            exp(lambda21 + flag1_pre2*beta_int1 + flag2_pre2*beta_int2 + s21_l)
          );
          ...
          P_total *= transition_matrix(
            ...
            exp(lambda21 + flag1_post2*beta_int1 + flag2_post2*beta_int2 + s21_l)
          );
          ...
          P_total *= transition_matrix(
            ...
            exp(lambda21 + flag1_l*beta_int1 + flag2_l*beta_int2 + s21_l)
          );
        }
      }
...
generated quantities {
  ...
  real                  a0_1_2_out = a0_1_2;
  real                  a0_2_1_out = a0_2_1;
...
if (first_subinterval[n] > 0) {
  ...
  if (t0 < t_star1 && t_star1 < t1) {
    ...
    P_total *= transition_matrix(
      ...
      exp(log21 + 0*beta_int1 + 0*beta_int2 + s21)
    );
    ...
    P_total *= transition_matrix(
      ...
      exp(log21 + flag1_post1*beta_int1 + flag2_post1*beta_int2 + s21)
    );
    ...
    P_total *= transition_matrix(
      ...
      exp(log21 + flag1_1*beta_int1 + flag2_1*beta_int2 + s21)
    );
  }
}
...
for (m in 1:num_middle_subintervals[n]) {
  ...
  if (t0m < t_star1 && t_star1 < t1m) {
    ...
    P_total *= transition_matrix(
      ...
      exp(log21 + 0*beta_int1 + 0*beta_int2 + s21m)
    );
    ...
    P_total *= transition_matrix(
      ...
      exp(log21 + flag1_post1m*beta_int1 + flag2_post1m*beta_int2 + s21m)
    );
    ...
    P_total *= transition_matrix(
      ...
      exp(log21 + flag1_2m*beta_int1 + flag2_2m*beta_int2 + s21m)
    );
  }
}
...
if (last_subinterval[n] > 0) {
  ...
  if (t0l < t_star2 && t_star2 < t1l) {
    ...
    P_total *= transition_matrix(
      ...
      exp(log21 + 1*beta_int1 + 0*beta_int2 + s21l)
    );
    ...
    P_total *= transition_matrix(
      ...
      exp(log21 + 1*beta_int1 + 1*beta_int2 + s21l)
    );
    ...
    P_total *= transition_matrix(
      ...
      exp(log21 + flag1_l*beta_int1 + flag2_l*beta_int2 + s21l)
    );
  }
}
