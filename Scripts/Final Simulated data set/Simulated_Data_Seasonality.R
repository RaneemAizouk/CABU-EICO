###############################################################################
# CREATE SIMULATED DATA WITH SEASONAL PATTERNS
###############################################################################
...
# STORE DATASET
#--------------------------------------------------------------------------------------------
saveRDS(stan_data, "./Data/Simulated_data/Simulated_data_seasonality_stan_data.rds")
...
if (last_subinterval_sim[n] > 0) {
  ...
  //----------------------------------------------------------------------------------------------------------
...

    {
      ...
      // REWRITTEN: use the state produced by the subinterval simulation directly (no extra draw)
...
#--------------------------------------------------------------------------------------------
saveRDS(simulated_dataset, "./Data/Simulated_data/Simulated_data_seasonality.rds")
...
pdf(file = "./Output/Figures/Simulated_data/simulated_data_check_seasonality3.pdf", width = 15, height = 8)
