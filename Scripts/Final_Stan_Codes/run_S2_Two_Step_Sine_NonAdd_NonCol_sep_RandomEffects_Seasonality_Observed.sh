...
export scenario="Two_step_sine_NonAdd_NonCol_sep_RandomEffects_seasonality"
...
# Run R script 
Rscript ./CABU_EICO/model-code/S2_Two_Step_Sine_NonAdd_NonCol_sep_RandomEffects.R "$scenario" "$data_source"
