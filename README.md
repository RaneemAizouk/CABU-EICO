...
The following Stan-based model scripts implement the Bayesian continuous-time multi-state (Markov) models used to evaluate intervention and seasonality scenarios for ESBL-E transmission dynamics:
11) S2_Two_Step_Sine.R
Two-step intervention, sinusoidal seasonality, intervention affects acquisition only.
12) S1_One_Step_Sine.R
One-step intervention, sinusoidal seasonality, acquisition-only effect.
13) S2_Two_Step_Spline.R
Two-step intervention, flexible cubic B-spline seasonality with acquisition-only intervention effects.
14) S1_One_Step_Spline.R
One-step intervention, flexible cubic B-spline seasonality with acquisition-only intervention effects.
15) S1_One_Step_Sine_NonAdd_NonCol.R
One-step intervention, sinusoidal seasonality, intervention allowed to affect both acquisition and decolonisation hazards (acquisition + decolonisation).
16) S2_Two_Step_Sine_NonAdd_NonCol.R
Two-step intervention, sinusoidal seasonality, intervention allowed to affect both acquisition and decolonisation hazards (acquisition + decolonisation).
17) S1_One_Step_Spline_NonAdd_NonCol.R
One-step intervention, flexible cubic B-spline seasonality, intervention allowed to affect both acquisition and decolonisation hazards (acquisition + decolonisation).
18) S2_Two_Step_Spline_NonAdd_NonCol.R
Two-step intervention, flexible cubic B-spline seasonality, intervention allowed to affect both acquisition and decolonisation hazards (acquisition + decolonisation).
# Related publications
1) [CABU-EICO study protocol – Trials (2024)](https://pubmed.ncbi.nlm.nih.gov/38281023/)
2) Aizouk R. et al., *The effect of a community-based intervention bundle on household transmission of ESBL-E in rural Burkina Faso* (manuscript — to be added).
